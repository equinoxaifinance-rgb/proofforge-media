...
- Mode: online
- Current release state: Review — live OpenAI/B2 receipt verified; owner conflict attestation and public assets pending
...
| B2 Storage and Data Orchestration | 25 | Show content-addressed object/manifest keys and fetch the stored object back to reproduce the SHA-256. | B2 sink, manifest read/verify, key recovery, and fetch-back comparison implemented; approved live B2 receipt and byte-identical recovery verified. |
